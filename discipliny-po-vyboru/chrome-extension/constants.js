const PROXY_URL_KEY = "its_proxy_url";
const NOTION_MAIN_PAGE_KEY = "its_notion_main_page_url";

const PROXY_URL_VALUE = "https://d5d7uvahlv4glcs1qbad.apigw.yandexcloud.net/notion/";
